				...
				<form action="curso.php" method="post" enctype="multipart/form-data">                      
					<div class="row">
						...
						<div class="col-sm-12 col-md-6">
							...
							<textarea name="sobre" class="form-control" rows="10" placeholder="Descreva o curso" id="sobre" maxlength="250" required autofocus><?php echo $ln['sobre']; ?></textarea>											
						</div>
						<div class="col-sm-12 col-md-6">
							<label for="Sobre">Mercado de Trabalho<em>*</em><em><small class="caracteres"></small></em></label>
							<textarea name="mercado" class="form-control" rows="10" placeholder="Apresente o Mercado de trabalho" maxlength="250" id="mercado" required autofocus><?php echo $ln['mercado']; ?></textarea>											
						</div>
					</div>
					<div class="modal-footer">
						<button type="button" class="btn btn-danger" data-dismiss="modal">Fechar</button>

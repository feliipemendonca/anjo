...
<head>
    <title>Faciliit Soluções em Tecnologias</title>
...
<div class="container">
    ...
    <div class="banner-text">
        <div class="slider-info">
            <h3>VAMOS FACILITAR SUA VIDA</h3>
            <p class="mt-3">Somos uma empresa de desenvolvimento de sistemas e infraestrutura de computadores para micro e pequenas empresas. Desenvolvemos soluções para facilitar a sua vida empresarial, na administração direta e indireta do seu negocio </p>
...
<div class="agileits-services py-md-5 py-4">
    <div class="container py-lg-5">
        <div class="text-center wthree-title pb-sm-5 pb-3">
            <h3 class="tittle-w3ls pb-4">Services</h3>
        </div>
        <div class="agileits-services-row row mt-lg-5 no-gutters">
            <div class="col-lg-4 col-md-6">
                <div class="agileits-services-grids">
                    <span class="fas fa-fast-backward"></span>
                    <h4 class="my-2">Montagem e Manutenção
                        <span></span>
                    </h4>
                    <p>Projetamos toda sua rede de computadores, seguindo os altos pardrões de qualidade(ABNT - 14565).</p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="agileits-services-grids mt-md-0 mt-5 px-lg-5">
                    <span class="fas fa-share-square"></span>
                    <h4 class="my-2">Consultoria 
                        <span></span>
                    </h4>
                    <p>Consultoria em infraestrutura, desenvolvimento de sistemas, marketing digital. </p>
                </div>
            </div>
            <div class="col-lg-4 col-md-6">
                <div class="agileits-services-grids mt-lg-0 mt-5 pl-lg-5">
                    <span class="far fa-star"></span>
                    <h4 class="my-2">Desenvolvimento para Internet
                        <span></span>
                    </h4>
                    <p>Desenvolvimento de sites, aplicativos para internet (portais, e-commece, landing page).</p>
                </div>
            </div>
    <!--
...
<!-- //services-->
<!-- testimonials -
<div class="testimonials py-md-5 py-4">
<div class="container py-lg-5">
...
elit.
<i class="fas fa-quote-right pl-3"></i>
</p>
...
<div class="contact-wthree py-md-5 py-4">
    <div class="container py-lg-5">
        <div class="text-center wthree-title pb-sm-5 pb-3">
            <h3 class="tittle-w3ls pb-4">Entre em Contato</h3>
        </div>
        <div class="project-top mx-auto mt-lg-0 mt-5">
            <!-- register form grid -->
            <div class="register-top1">
                <form action="config.php" method="post" class="register-wthree">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-6 inpt-form">
                                ...
                                <input class="form-control" type="text" placeholder="Telefone de Preferencia Whatsapp" name="tel" required>
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                ...
                                <textarea placeholder="Mensagem" name="msg" class="form-control" rows="5" required></textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row mt-lg-5 mt-3">
                        ...
                        <div class="col-md-12">
                            <button type="submit" class="btn btn-agile btn-block w-100" name="enviar" value="enviar">Enviar</button>
                        </div>
                    </div>
                </form>
            </div>
...
<!-- //contact -->
    ...
    <div id="small-dialog1" class="mfp-hide">
        <div class="agileits_modal_body">
            <iframe src="https://player.vimeo.com/video/113254244"></iframe>
        </div>
    </div>
    <!-- // video-button-popup -->
</div>
...
<!-- //video -->
   <!-- partners  --
   <div class="agileits-partners py-md-5 py-4">
   <div class="container py-lg-5">
   <div class="text-center wthree-title pb-sm-5 pb-3">
   <h3 class="tittle-w3ls pb-4">Our Partners</h3>
   <p class="tit mx-auto">Donec consequat sapien ut leo cursus rhoncus. Nullam dui mi, vulputate ac metus at, semper varm hic tenetur
